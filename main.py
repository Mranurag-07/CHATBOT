...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","crazy_helpz")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","lIPhoenixlll")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","trigo_help")
